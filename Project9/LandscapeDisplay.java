...
public class LandscapeDisplay extends JFrame
{
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Landscape scape = new Landscape(600, 600);
        // for (int i = 0; i < 6; i++) {
        //     Vertex ver = new Vertex(0, 0+(3*i), 5);
        //     ver.setVisible( true);
        //     scape.addBackground( ver );
        // }

        Vertex a = new Vertex(0, 2, 2);
        Vertex b = new Vertex(0, 3, 3);
        Vertex c = new Vertex(0, 4, 4);
        a.setVisible( true);
        b.setVisible( true);
        c.setVisible( true);
        scape.addBackground( a );
        scape.addBackground( b );
        scape.addBackground( c );
        a.connect(b, Direction.EAST);
		b.connect(c, Direction.SOUTH);
		c.connect(a, Direction.WEST);
		// v4.connect(v1, Direction.NORTH);
		Hunter hunt = new Hunter(0, 0, b);
		scape.addForeground( hunt );
		Wumpus wump = new Wumpus(0, 0, c);
		scape.addForeground( wump );
		wump.setVisible(true);
